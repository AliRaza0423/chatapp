...
import 'package:chatapp/screens/messages/components/AudioMessage.dart';
import 'package:chatapp/screens/messages/components/TextMessage.dart';
import 'package:chatapp/screens/messages/components/VideoMessage.dart';
...
class MessageDotStatus extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Icon(
        message.messageStatus == MessageStatus.not_sent ? Icons.close :
        Icons.done,
        size: 8,
